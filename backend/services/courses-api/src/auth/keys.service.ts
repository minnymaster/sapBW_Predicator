...
/**
 * KeysService — RSA-ключи для верификации JWT RS256.
 * Загрузка происходит СИНХРОННО в конструкторе.
 * В продакшне каталог keys/ должен быть смонтирован из manage-api
 * (они должны использовать одну пару ключей).
 */
@Injectable()
